...
try
{
    ...
    builder.Services.AddScoped<IResponseDomain, NatsManagementAdapter>();
    builder.Services.AddScoped<IResponseDomain, SendEtlAdapter>();
    builder.Services.AddScoped<IResponseDomain, TestConnection>();
